...
public class PersistenciaException extends Exception{
    ...
    /**
     * Método constructor que inicializa el objeto con un mensaje, un lanzable, un 
     * @param string mensaje de excepción.
     * @param thrwbl lanzable de excepción.
     * @param bln valor booleano que indica si se debe habilitar la supresión de excepciones
     * @param bln1 valor booleano que indica si se debe habilitar el seguimiento de la pila de excepciones
     */
